...
public class QuidcoCompareFaqPageObject {
    ...
    public static String compareGridOptionsFaq = "//div[@class='card__header--split-title']/h4[text()='%s']";

    public static String quidcoCompareFaqTabs = "//div[@class=\"proposition__nav\"]//ul[contains(@class,\"nav-tabs\")]//li/a[text()='%s']";
