...
public class LandingPageObject {
    ...
    @FindBy(xpath = "//ul[contains(@class,\"header-additional-links\")]//a[text()=\"Ways to Earn\"]/..//li[@class=\"ways-to-earn__item ways-to-earn__item--opinions\"]")
    public static WebElement quidcoOpinionsLink;
